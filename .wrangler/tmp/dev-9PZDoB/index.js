...
var src_default = {
  async fetch(request, env) {
    ...
    try {
      return await getAssetFromKV({ request, waitUntil: /* @__PURE__ */ __name(() => {
      }, "waitUntil") }, {
        mapRequestToAsset: /* @__PURE__ */ __name((req) => new Request(req.url.replace(/\/$/, "/index.html"), req), "mapRequestToAsset")
      });
    } catch (e) {
...
// .wrangler/tmp/bundle-CEHmk9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CEHmk9/middleware-loader.entry.ts
