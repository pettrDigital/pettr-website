export async function onRequestPost(context) {
  try {
    ...
    const smsMessage = `Hi ${name.split(' ')[0]}, thank you for contacting Plumber & Electrician To The Rescue. Someone from our team will be in touch shortly. For emergency response, please call us on 02 8103 4607.`;
...
async function writeFirestore(env, docId, data, collection) {
...
async function sendSMS(env, to, message) {
  ...
  await fetch('https://api.transmitsms.com/send-sms.json', {
    method: 'POST',
    headers: {
